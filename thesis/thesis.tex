...
d(x,z) &\leq d_M(x,y) + d_M(y,z) & triangle \ inequality
\end{align} 
...
\begin{align}
d_M(x,y) &\geq 0 & nonnegativity \\
d_M(x,x) &= 0 & identity \\
d_M(x,y) &= d(y,x) & symmetry \\
d_M(x,z) &\leq d_M(x,y) + d_M(y,z) & triangle \ inequality
\end{align} 
...
\section{Covariance Metric} \label{chap:rw:cov}
\cite{mahalanobis1936generalized}
