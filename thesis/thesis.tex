...
\section{Classification} \label{chap:experiment-knn}
...
\section{Generalization of evolutionary algorithms} \label{chap:experiment-fitness}


\section{Dimensionality reduction} \label{chap:experiment-dim-reduction}
