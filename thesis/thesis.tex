...
\section{Simple Covariance Metric}
\cite{mahalanobis1936generalized}

\section{Xing}
\cite{xing2002distance}

\section{Large Margin Nearest Neighbor (LMNN)}
\cite{weinberger2009distance}

\section{Information Theoretic Metric Learning (ITML)}
\cite{davis2007information}

\section{Sparse Determinant Metric Learning (SDML)}
\cite{qi2009efficient}

\section{Least Squares Metric Learning (LSML)}
\cite{liu2012metric}

\section{Neighborhood Components Analysis (NCA) \\}
\cite{jacobgoldberger2004neighbourhood}

\section{Local Fisher Discriminant Analysis (LFDA)}
\cite{sugiyama2007dimensionality}

\section{Relative Components Analysis (RCA)}
\cite{shental2002adjustment}

\section{Evolutionary distance metric learning}
