...
Short info about all datasets we used.

Table with \#classes, \#dimensions, \#samples.
...
\begin{figure} \label{fig:foo} \centering
    \includegraphics[width=1.0\textwidth]{img/dim-reduction/foo}
    \caption{Logo of MFF UK}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{img/dim-reduction/balance-scale-plot}
    \caption{Logo of MFF UK}
    \label{fig:xxx}
\end{figure}
