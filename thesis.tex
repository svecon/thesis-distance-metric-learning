...
Metric learning can also be used for dimensionality reduction as already discussed in Section \ref{chap:intro}. In this work we mainly focus on dimensionality reduction into two dimensions where it is easy to visualise the data.
