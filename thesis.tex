...
%TODO zacit odstavcem, ktery vypichne nejlepsi metody (uderni shrnuti)... teprve pak nejake zabrednuti 

%TODO "\ac{knn} behaves much better as a fitness" Pilat: to se da trochu cekat, pro to knn totiz optimalizuje primo to, co te zajima; fme pocita trochu neco jineho
...
%TODO [full vs diagonal!?]
%TODO [some datasets too large]
...
%TODO "only ran each experiment ONCE..." REWRITE... we only care about the (evolution??) of the fitness, not exact values?
