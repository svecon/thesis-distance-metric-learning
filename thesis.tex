...
\cenfig{graphs/dimred/balance-scale}{Dimensionality reduction on `balance-scale` dataset}{fig:dimred:balance-scale}
\cenfig{graphs/dimred/breast-cancer}{Dimensionality reduction on `breast-cancer` dataset}{fig:dimred:breast-cancer}
\cenfig{graphs/dimred/digits6}{Dimensionality reduction on `digits6` dataset}{fig:dimred:digits6}
\cenfig{graphs/dimred/digits10}{Dimensionality reduction on `digits10` dataset}{fig:dimred:digits10}
\cenfig{graphs/dimred/gaussians}{Dimensionality reduction on `gaussians` dataset}{fig:dimred:gaussians}
\cenfig{graphs/dimred/iris}{Dimensionality reduction on `iris` dataset}{fig:dimred:iris}
\cenfig{graphs/dimred/mice-protein}{Dimensionality reduction on `mice-protein` dataset}{fig:dimred:mice-protein}
\cenfig{graphs/dimred/pima-indians}{Dimensionality reduction on `pima-indians` dataset}{fig:dimred:pima-indians}
\cenfig{graphs/dimred/sonar}{Dimensionality reduction on `sonar` dataset}{fig:dimred:sonar}
\cenfig{graphs/dimred/wine}{Dimensionality reduction on `wine` dataset}{fig:dimred:wine}


\subsection{Neural Network transformation}

\cenfig{graphs/dimrednn/balance-scale}{Dimensionality reduction using neural network transformation on `balance-scale` dataset}{fig:dimrednn:balance-scale}
\cenfig{graphs/dimrednn/breast-cancer}{Dimensionality reduction using neural network transformation on `breast-cancer` dataset}{fig:dimrednn:breast-cancer}
\cenfig{graphs/dimrednn/digits6}{Dimensionality reduction using neural network transformation on `digits6` dataset}{fig:dimrednn:digits6}
\cenfig{graphs/dimrednn/digits10}{Dimensionality reduction using neural network transformation on `digits10` dataset}{fig:dimrednn:digits10}
\cenfig{graphs/dimrednn/gaussians}{Dimensionality reduction using neural network transformation on `gaussians` dataset}{fig:dimrednn:gaussians}
\cenfig{graphs/dimrednn/iris}{Dimensionality reduction using neural network transformation on `iris` dataset}{fig:dimrednn:iris}
\cenfig{graphs/dimrednn/mice-protein}{Dimensionality reduction using neural network transformation on `mice-protein` dataset}{fig:dimrednn:mice-protein}
\cenfig{graphs/dimrednn/pima-indians}{Dimensionality reduction using neural network transformation on `pima-indians` dataset}{fig:dimrednn:pima-indians}
\cenfig{graphs/dimrednn/sonar}{Dimensionality reduction using neural network transformation on `sonar` dataset}{fig:dimrednn:sonar}
\cenfig{graphs/dimrednn/wine}{Dimensionality reduction using neural network transformation on `wine` dataset}{fig:dimrednn:wine}
