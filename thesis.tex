...
In this work, we extend upon the research of \cite{fukui2013evolutionary} and we also use \aclp{ea} to evolve a real-valued matrix for Mahalanobis metric, nevertheless, there are notable differences in our methods which we will describe in this chapter. Their work was focused on improving clustering, meanwhile our method focuses on classification and dimensionality reduction.
